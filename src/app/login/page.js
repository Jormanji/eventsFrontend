...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    // Check if username and password are properly set
      ...
      <div className="flex justify-center items-center h-screen bg-backgroundPurple">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full bg-primaryPurple text-white p-2 rounded hover:bg-secondaryPurple"
            >
              Log In
            </button>
          </form>
          ...
          <Link href="/signup" className="text-primaryPurple flex justify-center">
            Sign Up
          </Link>
        </div>
      </div>
